...
int bt_enable() {
    ...
    for (attempt = 150; attempt > 0;  attempt--) {
...
#ifdef SW_BOARD_HAVE_BLUETOOTH_BCM
    system("echo 1 > /proc/bluetooth/sleep/proto");
#endif
...
#ifdef SW_BOARD_HAVE_BLUETOOTH_BCM
    system("echo 0 > /proc/bluetooth/sleep/proto");
#endif
